...
public class DTDashboard : MonoBehaviour
{
    ...
    public void ShowDT()
    {
        ...
        targetTXT.text = "Target location: " + "( "
            + GlobalInstance.Instance.jsonData["features"][6]["parameters"]["controlParameters"]["targetLocation"][0] 
            + ", " + GlobalInstance.Instance.jsonData["features"][6]["parameters"]["controlParameters"]["targetLocation"][1] 
            + ", " + GlobalInstance.Instance.jsonData["features"][6]["parameters"]["controlParameters"]["targetLocation"][2] + " )";
    }
}
